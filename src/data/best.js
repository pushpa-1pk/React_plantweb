export const O2plants = [
  {
    ...
    benefits: [
      "Purifies and oxygenates indoor air",
  ...
  },
  {
    ...
    benefits: [
      "Boosts nighttime oxygen levels",
      "Purifies indoor air and reduces harmful particles",
      "Helpful gel for skin healing and burns",
    ],
  },
  {
    id: 3,
    ...
    benefits: [
      "High oxygen release during daylight",
  ...
  },
  {
    ...
    benefits: [
      "Removes mold spores and pollutants",
      "Improves humidity and air purity",
      "Releases fresh oxygen indoors",
    ],
  },
  {
    id: 5,
    ...
    benefits: [
      "Releases oxygen during day & night",
